(function(){
  var ref$, chooseInt, choose, asGenerator, choice, frequency, sequence, size, label, transform, repeat, join, char, toInteger, toUnsignedInteger, toObject, Any, Null, Undefined, Bool, Num, Byte, Char, Str, Int, UInt, Positive, Negative, NumChar, UpperChar, LowerChar, AlphaChar, AlphaNumChar, AlphaStr, NumStr, AlphaNumStr, Id, start, chars, rest, List, Map, Nothing, Falsy, slice$ = [].slice;
  ref$ = require('./random'), chooseInt = ref$.chooseInt, choose = ref$.choose;
  ref$ = require('./generating'), asGenerator = ref$.asGenerator, choice = ref$.choice, frequency = ref$.frequency, sequence = ref$.sequence, size = ref$.size, label = ref$.label, transform = ref$.transform, repeat = ref$.repeat;
  join = function(it){
    return it.join('');
  };
  ...
  importAll$(Any, choice(Nothing, Bool, Num, Str, List(Any), Map(Any)));
  module.exports = {
    Null: Null,
    Undefined: Undefined,
    Bool: Bool,
